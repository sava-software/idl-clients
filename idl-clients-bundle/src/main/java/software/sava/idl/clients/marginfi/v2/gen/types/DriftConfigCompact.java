...
public record DriftConfigCompact(PublicKey oracle,
  ...
  public static DriftConfigCompact read(final byte[] _data, final int _offset) {
    ...
    return new DriftConfigCompact(oracle,
                                  assetWeightInit,
                                  assetWeightMaint,
                                  depositLimit,
                                  oracleSetup,
