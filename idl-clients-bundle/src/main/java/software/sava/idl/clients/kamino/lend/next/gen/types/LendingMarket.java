...
/// @param version: u64
/// @param bumpSeed: u64
/// @param referralFeeBps: u16
/// @param emergencyMode: u8
/// @param autodeleverageEnabled: u8
/// @param borrowDisabled: u8
/// @param priceRefreshTriggerToMaxAgePct: u8
/// @param liquidationMaxDebtCloseFactorPct: u8
/// @param insolvencyRiskUnhealthyLtvPct: u8
/// @param minFullLiquidationValueThreshold: u64
/// @param maxLiquidatableDebtMarketValueAtOnce: u64
/// @param globalAllowedBorrowValue: u64
/// @param elevationGroupPadding: u64[]
/// @param minValueSkipLiquidationLtvChecks: u64
/// @param minValueSkipLiquidationBfChecks: u64
/// @param individualAutodeleverageMarginCallPeriodSecs: u64
/// @param minInitialDepositAmount: u64
/// @param obligationOrderExecutionEnabled: u8
/// @param immutable: u8
/// @param obligationOrderCreationEnabled: u8
/// @param priceTriggeredLiquidationDisabled: u8
/// @param matureReserveDebtLiquidationEnabled: u8
/// @param obligationBorrowDebtTermLiquidationEnabled: u8
/// @param borrowOrderCreationEnabled: u8
/// @param borrowOrderExecutionEnabled: u8
/// @param minBorrowOrderFillValue: u64
/// @param withdrawTicketIssuanceEnabled: u8
/// @param withdrawTicketRedemptionEnabled: u8
/// @param obligationBorrowRolloverConfigurationEnabled: u8
/// @param obligationBorrowMigrationToFixedExecutionEnabled: u8
/// @param withdrawTicketCancellationEnabled: u8
/// @param disableNonceBlock: u8
/// @param reserveRewardsMaxAprBps: u16
/// @param minWithdrawQueuedLiquidityValue: u64
/// @param fixedTermRolloverWindowDurationSeconds: u64
/// @param openTermRolloverWindowDurationSeconds: u64
/// @param minPartialRolloverValue: u64
/// @param termBasedFullLiquidationDurationSecs: u64
/// @param permissionedOps: u64
/// @param padding1: u64[]
public record LendingMarket(PublicKey _address,
  ...
  public static LendingMarket readChecked(final PublicKey _address, final byte[] _data) {
    return readChecked(_address, _data, 0);
  }

  public static LendingMarket readChecked(final PublicKey _address, final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    if (!DISCRIMINATOR.equals(_data, _offset)) {
      throw new IllegalArgumentException("Not a LendingMarket account.");
    }
    return read(_address, _data, _offset);
  }

  public static final BiFunction<PublicKey, byte[], LendingMarket> FACTORY = LendingMarket::readChecked;
