...
/// @param borrowedAmountsAgainstThisReserveInElevationGroups: u64[]
/// @param padding: u64[]
public record Reserve(PublicKey _address,
  ...
  public static final int CONFIG_PADDING_LEN = 112;
  ...
  public static final int CONFIG_PADDING_OFFSET = 5808;
  ...
  public static Reserve readChecked(final PublicKey _address, final byte[] _data) {
    return readChecked(_address, _data, 0);
  }

  public static Reserve readChecked(final PublicKey _address, final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    if (!DISCRIMINATOR.equals(_data, _offset)) {
      throw new IllegalArgumentException("Not a Reserve account.");
    }
    return read(_address, _data, _offset);
  }

  public static final BiFunction<PublicKey, byte[], Reserve> FACTORY = Reserve::readChecked;
  ...
  public int write(final byte[] _data, final int _offset) {
    ...
    i += SerDeUtil.writeArrayChecked(configPadding, 112, _data, i);
