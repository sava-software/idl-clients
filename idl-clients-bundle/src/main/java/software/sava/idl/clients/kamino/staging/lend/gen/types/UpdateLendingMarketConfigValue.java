...
public sealed interface UpdateLendingMarketConfigValue extends RustEnum permits
  ...
  record ElevationGroup(software.sava.idl.clients.kamino.staging.lend.gen.types.ElevationGroup val) implements SerDeEnum, UpdateLendingMarketConfigValue {

    public static ElevationGroup read(final byte[] _data, final int _offset) {
      return new ElevationGroup(software.sava.idl.clients.kamino.staging.lend.gen.types.ElevationGroup.read(_data, _offset));
    }
