...
public record UserState(PublicKey _address,
  ...
  public static UserState read(final PublicKey _address, final byte[] _data, final int _offset) {
    ...
    i += SerDeUtil.readU128Array(rewardsTallyScaled, _data, i);
    ...
    final var activeStakeScaled = getUInt128LE(_data, i);
    i += 16;
    final var pendingDepositStakeScaled = getUInt128LE(_data, i);
    i += 16;
    final var pendingDepositStakeTs = getInt64LE(_data, i);
    i += 8;
    final var pendingWithdrawalUnstakeScaled = getUInt128LE(_data, i);
    i += 16;
  ...
  public int write(final byte[] _data, final int _offset) {
    ...
    i += SerDeUtil.writeU128ArrayChecked(rewardsTallyScaled, 10, _data, i);
