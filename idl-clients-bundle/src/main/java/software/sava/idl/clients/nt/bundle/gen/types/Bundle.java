...
public record Bundle(PublicKey _address,
  ...
  public static Bundle readChecked(final PublicKey _address, final byte[] _data) {
    return readChecked(_address, _data, 0);
  }

  public static Bundle readChecked(final PublicKey _address, final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    if (!DISCRIMINATOR.equals(_data, _offset)) {
      throw new IllegalArgumentException("Not a Bundle account.");
    }
    return read(_address, _data, _offset);
  }

  public static final BiFunction<PublicKey, byte[], Bundle> FACTORY = Bundle::readChecked;
  ...
  public static Bundle read(final PublicKey _address, final byte[] _data, final int _offset) {
    ...
    i += 8;
    final var referralTiers = new ReferralTier[5];
