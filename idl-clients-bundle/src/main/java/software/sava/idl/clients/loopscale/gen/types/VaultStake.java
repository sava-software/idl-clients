...
/// @param startTime: u64
/// @param endTime: u64
/// @param unstakeTime: u64
/// @param unstakeFeeApplied: u64
public record VaultStake(PublicKey _address,
  ...
  public static VaultStake readChecked(final PublicKey _address, final byte[] _data) {
    return readChecked(_address, _data, 0);
  }

  public static VaultStake readChecked(final PublicKey _address, final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    if (!DISCRIMINATOR.equals(_data, _offset)) {
      throw new IllegalArgumentException("Not a VaultStake account.");
    }
    return read(_address, _data, _offset);
  }

  public static final BiFunction<PublicKey, byte[], VaultStake> FACTORY = VaultStake::readChecked;
