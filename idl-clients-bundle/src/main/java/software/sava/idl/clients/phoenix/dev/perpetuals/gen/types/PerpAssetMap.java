...
public record PerpAssetMap(PublicKey _address,
  ...
  public static final int NUM_ASSETS_OFFSET = 24;
  public static final int PADDING_0_OFFSET = 26;
  public static final int METADATAS_OFFSET = 32;
  ...
  public static PerpAssetMap readChecked(final PublicKey _address, final byte[] _data) {
    return readChecked(_address, _data, 0);
  }

  public static PerpAssetMap readChecked(final PublicKey _address, final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    if (!DISCRIMINATOR.equals(_data, _offset)) {
      throw new IllegalArgumentException("Not a PerpAssetMap account.");
    }
    return read(_address, _data, _offset);
  }

  public static final BiFunction<PublicKey, byte[], PerpAssetMap> FACTORY = PerpAssetMap::readChecked;
