...
public record ProtocolPositionState(PublicKey _address,
  ...
  public static final int FEE_GROWTH_INSIDE_0_LAST_X_64_OFFSET = 65;
  public static final int FEE_GROWTH_INSIDE_1_LAST_X_64_OFFSET = 81;
  ...
  public static ProtocolPositionState readChecked(final PublicKey _address, final byte[] _data) {
    return readChecked(_address, _data, 0);
  }

  public static ProtocolPositionState readChecked(final PublicKey _address, final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    if (!DISCRIMINATOR.equals(_data, _offset)) {
      throw new IllegalArgumentException("Not a ProtocolPositionState account.");
    }
    return read(_address, _data, _offset);
  }

  public static final BiFunction<PublicKey, byte[], ProtocolPositionState> FACTORY = ProtocolPositionState::readChecked;
  ...
  public static ProtocolPositionState read(final PublicKey _address, final byte[] _data, final int _offset) {
    ...
    i += SerDeUtil.readU128Array(rewardGrowthInside, _data, i);
  ...
  public int write(final byte[] _data, final int _offset) {
    ...
    i += 8;
    i += SerDeUtil.writeU128ArrayChecked(rewardGrowthInside, 3, _data, i);
