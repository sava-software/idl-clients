...
public record MarketEventHeader(long sequenceNumber,
                                ...
                                PublicKey signer,
                                PublicKey traderAccount) implements SerDe {

  public static final int BYTES = 106;

  public static final int SEQUENCE_NUMBER_OFFSET = 0;
  public static final int PREV_SEQUENCE_NUMBER_SLOT_OFFSET = 8;
  public static final int ASSET_SYMBOL_OFFSET = 16;
  public static final int ASSET_ID_OFFSET = 32;
  public static final int TICK_SIZE_OFFSET = 36;
  public static final int BASE_LOT_DECIMALS_OFFSET = 40;
  public static final int QUOTE_LOT_DECIMALS_OFFSET = 41;
  public static final int SIGNER_OFFSET = 42;
  public static final int TRADER_ACCOUNT_OFFSET = 74;
  ...
  public static MarketEventHeader read(final byte[] _data, final int _offset) {
    ...
    return new MarketEventHeader(sequenceNumber,
