...
hardening {
  ...
  val generatedDecline =
      "idl-src-gen output: per-program instruction builders, account and type " +
          ...
          "with the idl.json they were generated from committed beside them in gen/. All 1672 " +
          "carry '@generated by sava-software idl-src-gen — DO NOT EDIT' and are never " +
          "hand-edited here (AGENTS.md: fixes belong in the generator, then regenerate), so a " +
          "ratchet on them would pin code this repo cannot change. Correctness is carried " +
