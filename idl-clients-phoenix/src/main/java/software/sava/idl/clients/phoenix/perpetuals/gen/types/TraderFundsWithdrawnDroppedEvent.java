...
///
public record TraderFundsWithdrawnDroppedEvent(Discriminator discriminator,
                                               PublicKey trader,
                                               PublicKey authority,
                                               long amount,
  ...
  public static final Discriminator DISCRIMINATOR = toDiscriminator(16, 0, 0, 0, 0, 0, 0, 0);
  ...
  public static TraderFundsWithdrawnDroppedEvent read(final byte[] _data, final int _offset) {
    ...
    return new TraderFundsWithdrawnDroppedEvent(discriminator,
                                                trader,
                                                authority,
                                                amount,
