...
///
public record TraderFundsWithdrawnEnqueuedEvent(Discriminator discriminator,
                                                PublicKey trader,
                                                PublicKey authority,
                                                long amount,
  ...
  public static final Discriminator DISCRIMINATOR = toDiscriminator(15, 0, 0, 0, 0, 0, 0, 0);
  ...
  public static TraderFundsWithdrawnEnqueuedEvent read(final byte[] _data, final int _offset) {
    ...
    return new TraderFundsWithdrawnEnqueuedEvent(discriminator,
                                                 trader,
                                                 authority,
                                                 amount,
