...
///
public record SplinePriceUpdatedWithOrderingEvent(Discriminator discriminator,
                                                  PublicKey trader,
                                                  long sequenceNumber,
  ...
  public static final Discriminator DISCRIMINATOR = toDiscriminator(56, 0, 0, 0, 0, 0, 0, 0);
  ...
  public static final int USER_SEQUENCE_NUMBER_OFFSET = 153;
  public static final int CLIENT_ORDER_ID_OFFSET = 161;

  public static SplinePriceUpdatedWithOrderingEvent read(final byte[] _data, final int _offset) {
    ...
    return new SplinePriceUpdatedWithOrderingEvent(discriminator,
                                                   trader,
                                                   sequenceNumber,
