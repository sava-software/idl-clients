...
import software.sava.idl.clients.phoenix.dev.perpetuals.gen.types.LogHeader;
...
import software.sava.idl.clients.phoenix.dev.perpetuals.gen.types.TransferCollateralChildToParentInstruction;
...
import software.sava.idl.clients.phoenix.dev.perpetuals.gen.types.UpdateSplineParametersParams;
import software.sava.idl.clients.phoenix.dev.perpetuals.gen.types.UpdateSplinePriceParams;
...
public final class EternalProgram {
  ...
  public static Instruction updateSplinePrice(final AccountMeta invokedEternalProgramMeta,
                                              ...
                                              final PublicKey traderAccountKey,
                                              final PublicKey splineAccountKey,
                                              final UpdateSplinePriceParams params) {
  ...
  public record UpdateSplinePriceIxData(Discriminator discriminator, UpdateSplinePriceParams params) implements SerDe {  
    ...
    public static UpdateSplinePriceIxData read(final byte[] _data, final int _offset) {
      ...
      final var discriminator = createAnchorDiscriminator(_data, _offset);
      int i = _offset + discriminator.length();
      final var params = UpdateSplinePriceParams.read(_data, i);
  ...
  public static Instruction updateSplineParameters(final AccountMeta invokedEternalProgramMeta,
                                                   ...
                                                   final PublicKey traderAccountKey,
                                                   final PublicKey splineAccountKey,
                                                   final UpdateSplineParametersParams params) {
  ...
  public record UpdateSplineParametersIxData(Discriminator discriminator, UpdateSplineParametersParams params) implements SerDe {  
    ...
    public static UpdateSplineParametersIxData read(final byte[] _data, final int _offset) {
      ...
      final var discriminator = createAnchorDiscriminator(_data, _offset);
      int i = _offset + discriminator.length();
      final var params = UpdateSplineParametersParams.read(_data, i);
