...
public record HolderDelegateRecord(PublicKey _address,
  ...
  public static HolderDelegateRecord read(final byte[] _data, final int _offset) {
  ...
  public static HolderDelegateRecord read(final PublicKey _address, final byte[] _data, final int _offset) {
