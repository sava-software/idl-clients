...
public record DepositedToDriftVault(Discriminator discriminator,
                                    long amount,
                                    PublicKey from,
                                    PublicKey to,
  ...
  public static final Discriminator DISCRIMINATOR = toDiscriminator(200, 86, 135, 159, 147, 246, 123, 85);
  ...
  public static DepositedToDriftVault read(final byte[] _data, final int _offset) {
    ...
    return new DepositedToDriftVault(discriminator,
                                     amount,
                                     from,
                                     to,
                                     timestamp);
