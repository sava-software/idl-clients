...
public record WithdrawnFromDriftVault(Discriminator discriminator,
                                      long amount,
                                      PublicKey from,
                                      PublicKey to,
  ...
  public static final Discriminator DISCRIMINATOR = toDiscriminator(249, 177, 58, 24, 88, 115, 105, 193);
  ...
  public static WithdrawnFromDriftVault read(final byte[] _data, final int _offset) {
    ...
    return new WithdrawnFromDriftVault(discriminator,
                                       amount,
                                       from,
                                       to,
                                       timestamp);
