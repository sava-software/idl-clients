...
public record BorrowOrderPartialFillEvent(Discriminator discriminator, BorrowOrder before, BorrowOrder after) implements KaminoLendingEvent {
  ...
  public static BorrowOrderPartialFillEvent read(final byte[] _data, final int _offset) {
