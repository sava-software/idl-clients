...
public record OracleQuoteOverrideEvent(Discriminator discriminator, PublicKey oracle, PublicKey queue) implements SbOnDemandEvent {
  ...
  public static OracleQuoteOverrideEvent read(final byte[] _data, final int _offset) {
    ...
    return new OracleQuoteOverrideEvent(discriminator, oracle, queue);
  }
