...
public record AuthorizeCheckedWithSeedParams(StakeAuthorize stakeAuthorize,
  ...
  public static AuthorizeCheckedWithSeedParams createRecord(final StakeAuthorize stakeAuthorize,
                                                            final String authoritySeed,
                                                            final PublicKey authorityOwner) {
    return new AuthorizeCheckedWithSeedParams(stakeAuthorize, authoritySeed, authoritySeed.getBytes(UTF_8), authorityOwner);
  }

  public static AuthorizeCheckedWithSeedParams read(final byte[] _data, final int _offset) {
    ...
    return new AuthorizeCheckedWithSeedParams(stakeAuthorize, authoritySeed, _authoritySeed, authorityOwner);
  }
