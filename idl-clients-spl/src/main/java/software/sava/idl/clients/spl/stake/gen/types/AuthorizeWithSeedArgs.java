...
public record AuthorizeWithSeedArgs(PublicKey newAuthorizedPubkey,
  ...
  public static AuthorizeWithSeedArgs createRecord(final PublicKey newAuthorizedPubkey,
                                                   final StakeAuthorize stakeAuthorize,
                                                   final String authoritySeed,
                                                   final PublicKey authorityOwner) {
    return new AuthorizeWithSeedArgs(newAuthorizedPubkey,
                                     stakeAuthorize,
                                     authoritySeed, authoritySeed.getBytes(UTF_8),
                                     authorityOwner);
  }

  public static AuthorizeWithSeedArgs read(final byte[] _data, final int _offset) {
