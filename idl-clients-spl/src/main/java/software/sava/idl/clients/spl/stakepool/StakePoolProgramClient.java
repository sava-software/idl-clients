...
public interface StakePoolProgramClient {
  ...
  static StakePoolProgramClient createClient(final SPLAccountClient splAccountClient,
                                             final StakePoolAccounts stakePoolAccounts) {
    return new StakePoolProgramClientImpl(splAccountClient, stakePoolAccounts);
  }

  static StakePoolProgramClient createClient(final SPLAccountClient splAccountClient) {
    return createClient(splAccountClient, StakePoolAccounts.MAIN_NET);
  }
