...
public record LockupArgs(UnixTimestamp unixTimestamp,
                         Epoch epoch,
                         PublicKey custodian) implements SerDe {

  public static final int UNIX_TIMESTAMP_OFFSET = 1;

  public static LockupArgs read(final byte[] _data, final int _offset) {
    ...
    return new LockupArgs(unixTimestamp, epoch, custodian);
  }
