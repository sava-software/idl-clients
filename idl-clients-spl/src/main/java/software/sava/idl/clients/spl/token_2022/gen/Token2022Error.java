...
public sealed interface Token2022Error extends ProgramError permits
    Token2022Error.NotRentExempt,
    Token2022Error.InsufficientFunds,
    Token2022Error.InvalidMint,
    Token2022Error.MintMismatch,
    Token2022Error.OwnerMismatch,
    Token2022Error.FixedSupply,
    Token2022Error.AlreadyInUse,
    Token2022Error.InvalidNumberOfProvidedSigners,
    Token2022Error.InvalidNumberOfRequiredSigners,
    Token2022Error.UninitializedState,
    Token2022Error.NativeNotSupported,
    Token2022Error.NonNativeHasBalance,
    Token2022Error.InvalidInstruction,
    Token2022Error.InvalidState,
    Token2022Error.Overflow,
    Token2022Error.AuthorityTypeNotSupported,
    Token2022Error.MintCannotFreeze,
    Token2022Error.AccountFrozen,
    Token2022Error.MintDecimalsMismatch,
    Token2022Error.NonNativeNotSupported {

  static Token2022Error getInstance(final int errorCode) {
  ...
  record NotRentExempt(int code, String msg) implements Token2022Error {
  ...
  record InsufficientFunds(int code, String msg) implements Token2022Error {
  ...
  record InvalidMint(int code, String msg) implements Token2022Error {
  ...
  record MintMismatch(int code, String msg) implements Token2022Error {
  ...
  record OwnerMismatch(int code, String msg) implements Token2022Error {
  ...
  record FixedSupply(int code, String msg) implements Token2022Error {
  ...
  record AlreadyInUse(int code, String msg) implements Token2022Error {
  ...
  record InvalidNumberOfProvidedSigners(int code, String msg) implements Token2022Error {
  ...
  record InvalidNumberOfRequiredSigners(int code, String msg) implements Token2022Error {
  ...
  record UninitializedState(int code, String msg) implements Token2022Error {
  ...
  record NativeNotSupported(int code, String msg) implements Token2022Error {
  ...
  record NonNativeHasBalance(int code, String msg) implements Token2022Error {
  ...
  record InvalidInstruction(int code, String msg) implements Token2022Error {
  ...
  record InvalidState(int code, String msg) implements Token2022Error {
  ...
  record Overflow(int code, String msg) implements Token2022Error {
  ...
  record AuthorityTypeNotSupported(int code, String msg) implements Token2022Error {
  ...
  record MintCannotFreeze(int code, String msg) implements Token2022Error {
  ...
  record AccountFrozen(int code, String msg) implements Token2022Error {
  ...
  record MintDecimalsMismatch(int code, String msg) implements Token2022Error {
  ...
  record NonNativeNotSupported(int code, String msg) implements Token2022Error {
