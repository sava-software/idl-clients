...
public record LiquidityIncreased(Discriminator discriminator,
  ...
  public static final Discriminator DISCRIMINATOR = toDiscriminator(30, 7, 144, 181, 102, 254, 155, 161);
  ...
  public static LiquidityIncreased read(final byte[] _data, final int _offset) {
    ...
    return new LiquidityIncreased(discriminator,
                                  whirlpool,
                                  position,
                                  tickLowerIndex,
                                  tickUpperIndex,
