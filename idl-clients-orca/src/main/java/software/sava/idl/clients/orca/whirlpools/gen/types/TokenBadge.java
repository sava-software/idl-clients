...
public record TokenBadge(PublicKey _address,
                         ...
                         PublicKey tokenMint,
                         boolean attributeRequireNonTransferablePosition) implements SerDe {
  ...
  public static final int TOKEN_MINT_OFFSET = 40;
  public static final int ATTRIBUTE_REQUIRE_NON_TRANSFERABLE_POSITION_OFFSET = 72;
  ...
  public static Filter createAttributeRequireNonTransferablePositionFilter(final boolean attributeRequireNonTransferablePosition) {
    return Filter.createMemCompFilter(ATTRIBUTE_REQUIRE_NON_TRANSFERABLE_POSITION_OFFSET, new byte[]{(byte) (attributeRequireNonTransferablePosition ? 1 : 0)});
  }
  ...
  public static TokenBadge read(final PublicKey _address, final byte[] _data, final int _offset) {
    ...
    i += 32;
    final var attributeRequireNonTransferablePosition = _data[i] == 1;
    return new TokenBadge(_address, discriminator, whirlpoolsConfig, tokenMint, attributeRequireNonTransferablePosition);
  }
  ...
  public int write(final byte[] _data, final int _offset) {
    ...
    i += 32;
    _data[i] = (byte) (attributeRequireNonTransferablePosition ? 1 : 0);
    ++i;
    return i - _offset;
  }
