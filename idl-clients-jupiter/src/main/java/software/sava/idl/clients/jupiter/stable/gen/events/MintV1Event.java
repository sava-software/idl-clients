...
public record MintV1Event(Discriminator discriminator,
                          long amount,
                          long netAmount,
                          long oraclePrice,
                          long oneToOneAmount,
                          long oracleAmount,
                          long mintAmount,
                          PublicKey collateral,
                          PublicKey benefactor) implements JupStableEvent {

  public static final int BYTES = 120;
  public static final Discriminator DISCRIMINATOR = toDiscriminator(63, 113, 88, 48, 163, 187, 48, 83);
  ...
  public static final int COLLATERAL_OFFSET = 56;
  public static final int BENEFACTOR_OFFSET = 88;

  public static MintV1Event read(final byte[] _data, final int _offset) {
    ...
    i += 8;
    final var collateral = readPubKey(_data, i);
    i += 32;
    final var benefactor = readPubKey(_data, i);
    return new MintV1Event(discriminator,
                           amount,
                           netAmount,
                           oraclePrice,
                           oneToOneAmount,
