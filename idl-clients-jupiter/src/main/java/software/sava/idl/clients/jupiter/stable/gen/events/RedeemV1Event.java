...
public record RedeemV1Event(Discriminator discriminator,
  ...
  public static final Discriminator DISCRIMINATOR = toDiscriminator(67, 51, 207, 92, 219, 144, 44, 2);
  ...
  public static RedeemV1Event read(final byte[] _data, final int _offset) {
    ...
    return new RedeemV1Event(discriminator,
                             amount,
                             netAmount,
                             oraclePrice,
                             oneToOneAmount,
