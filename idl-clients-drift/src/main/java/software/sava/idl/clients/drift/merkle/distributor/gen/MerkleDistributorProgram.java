...
public final class MerkleDistributorProgram {
  ...
  public record NewDistributorIxData(Discriminator discriminator,
    ...
    public static final int ROOT_OFFSET = 16;
    public static final int MAX_TOTAL_CLAIM_OFFSET = 48;
    public static final int MAX_NUM_NODES_OFFSET = 56;
    public static final int START_VESTING_TS_OFFSET = 64;
    public static final int END_VESTING_TS_OFFSET = 72;
    public static final int CLAWBACK_START_TS_OFFSET = 80;
    public static final int ENABLE_SLOT_OFFSET = 88;
    public static final int CLOSABLE_OFFSET = 96;
  ...
  public static List<AccountMeta> setEnableSlotKeys(final PublicKey distributorKey,
                                                    final PublicKey adminKey) {
    return List.of(
      createWrite(distributorKey),
      createWritableSigner(adminKey)
  ...
  public record SetEnableSlotIxData(Discriminator discriminator, long enableSlot) implements SerDe {  
    ...
    public static final int ENABLE_SLOT_OFFSET = 8;
  ...
  /// @param systemProgramKey The System program.
  public static List<AccountMeta> newClaimKeys(final PublicKey distributorKey,
                                               final PublicKey claimStatusKey,
  ...
  /// @param claimantKey Who is claiming the tokens.
  /// @param tokenProgramKey SPL Token program.
  public static List<AccountMeta> claimLockedKeys(final PublicKey distributorKey,
                                                  final PublicKey claimStatusKey,
                                                  final PublicKey fromKey,
                                                  final PublicKey toKey,
                                                  final PublicKey claimantKey,
