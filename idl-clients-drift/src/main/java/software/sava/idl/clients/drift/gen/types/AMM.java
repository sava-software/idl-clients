...
public record AMM(PublicKey oracle,
  ...
  public static final int HISTORICAL_ORACLE_DATA_OFFSET = 32;
  public static final int BASE_ASSET_AMOUNT_PER_LP_OFFSET = 80;
  public static final int QUOTE_ASSET_AMOUNT_PER_LP_OFFSET = 96;
  public static final int FEE_POOL_OFFSET = 112;
  public static final int BASE_ASSET_RESERVE_OFFSET = 136;
  public static final int QUOTE_ASSET_RESERVE_OFFSET = 152;
  public static final int CONCENTRATION_COEF_OFFSET = 168;
  public static final int MIN_BASE_ASSET_RESERVE_OFFSET = 184;
  public static final int MAX_BASE_ASSET_RESERVE_OFFSET = 200;
  public static final int SQRT_K_OFFSET = 216;
  public static final int PEG_MULTIPLIER_OFFSET = 232;
  public static final int TERMINAL_QUOTE_ASSET_RESERVE_OFFSET = 248;
  public static final int BASE_ASSET_AMOUNT_LONG_OFFSET = 264;
  public static final int BASE_ASSET_AMOUNT_SHORT_OFFSET = 280;
  public static final int BASE_ASSET_AMOUNT_WITH_AMM_OFFSET = 296;
  public static final int BASE_ASSET_AMOUNT_WITH_UNSETTLED_LP_OFFSET = 312;
  public static final int MAX_OPEN_INTEREST_OFFSET = 328;
  public static final int QUOTE_ASSET_AMOUNT_OFFSET = 344;
  public static final int QUOTE_ENTRY_AMOUNT_LONG_OFFSET = 360;
  public static final int QUOTE_ENTRY_AMOUNT_SHORT_OFFSET = 376;
  public static final int QUOTE_BREAK_EVEN_AMOUNT_LONG_OFFSET = 392;
  public static final int QUOTE_BREAK_EVEN_AMOUNT_SHORT_OFFSET = 408;
  public static final int USER_LP_SHARES_OFFSET = 424;
  public static final int LAST_FUNDING_RATE_OFFSET = 440;
  public static final int LAST_FUNDING_RATE_LONG_OFFSET = 448;
  public static final int LAST_FUNDING_RATE_SHORT_OFFSET = 456;
  public static final int LAST_22H_AVG_FUNDING_RATE_OFFSET = 464;
  public static final int TOTAL_FEE_OFFSET = 472;
  public static final int TOTAL_MM_FEE_OFFSET = 488;
  public static final int TOTAL_EXCHANGE_FEE_OFFSET = 504;
  public static final int TOTAL_FEE_MINUS_DISTRIBUTIONS_OFFSET = 520;
  public static final int TOTAL_FEE_WITHDRAWN_OFFSET = 536;
  public static final int TOTAL_LIQUIDATION_FEE_OFFSET = 552;
  public static final int CUMULATIVE_FUNDING_RATE_LONG_OFFSET = 568;
  public static final int CUMULATIVE_FUNDING_RATE_SHORT_OFFSET = 584;
  public static final int TOTAL_SOCIAL_LOSS_OFFSET = 600;
  public static final int ASK_BASE_ASSET_RESERVE_OFFSET = 616;
  public static final int ASK_QUOTE_ASSET_RESERVE_OFFSET = 632;
  public static final int BID_BASE_ASSET_RESERVE_OFFSET = 648;
  public static final int BID_QUOTE_ASSET_RESERVE_OFFSET = 664;
  public static final int LAST_ORACLE_NORMALISED_PRICE_OFFSET = 680;
  public static final int LAST_ORACLE_RESERVE_PRICE_SPREAD_PCT_OFFSET = 688;
  public static final int LAST_BID_PRICE_TWAP_OFFSET = 696;
  public static final int LAST_ASK_PRICE_TWAP_OFFSET = 704;
  public static final int LAST_MARK_PRICE_TWAP_OFFSET = 712;
  public static final int LAST_MARK_PRICE_TWAP_5MIN_OFFSET = 720;
  public static final int LAST_UPDATE_SLOT_OFFSET = 728;
  public static final int LAST_ORACLE_CONF_PCT_OFFSET = 736;
  public static final int NET_REVENUE_SINCE_LAST_FUNDING_OFFSET = 744;
  public static final int LAST_FUNDING_RATE_TS_OFFSET = 752;
  public static final int FUNDING_PERIOD_OFFSET = 760;
  public static final int ORDER_STEP_SIZE_OFFSET = 768;
  public static final int ORDER_TICK_SIZE_OFFSET = 776;
  public static final int MIN_ORDER_SIZE_OFFSET = 784;
  public static final int MM_ORACLE_SLOT_OFFSET = 792;
  public static final int VOLUME_22H_OFFSET = 800;
  public static final int LONG_INTENSITY_VOLUME_OFFSET = 808;
  public static final int SHORT_INTENSITY_VOLUME_OFFSET = 816;
  public static final int LAST_TRADE_TS_OFFSET = 824;
  public static final int MARK_STD_OFFSET = 832;
  public static final int ORACLE_STD_OFFSET = 840;
  public static final int LAST_MARK_PRICE_TWAP_TS_OFFSET = 848;
  public static final int BASE_SPREAD_OFFSET = 856;
  public static final int MAX_SPREAD_OFFSET = 860;
  public static final int LONG_SPREAD_OFFSET = 864;
  public static final int SHORT_SPREAD_OFFSET = 868;
  public static final int MM_ORACLE_PRICE_OFFSET = 872;
  public static final int MAX_FILL_RESERVE_FRACTION_OFFSET = 880;
  public static final int MAX_SLIPPAGE_RATIO_OFFSET = 882;
  public static final int CURVE_UPDATE_INTENSITY_OFFSET = 884;
  public static final int AMM_JIT_INTENSITY_OFFSET = 885;
  public static final int ORACLE_SOURCE_OFFSET = 886;
  public static final int LAST_ORACLE_VALID_OFFSET = 887;
  public static final int TARGET_BASE_ASSET_AMOUNT_PER_LP_OFFSET = 888;
  public static final int PER_LP_BASE_OFFSET = 892;
  public static final int ORACLE_LOW_RISK_SLOT_DELAY_OVERRIDE_OFFSET = 893;
  public static final int AMM_SPREAD_ADJUSTMENT_OFFSET = 894;
  public static final int ORACLE_SLOT_DELAY_OVERRIDE_OFFSET = 895;
  public static final int MM_ORACLE_SEQUENCE_ID_OFFSET = 896;
  public static final int NET_UNSETTLED_FUNDING_PNL_OFFSET = 904;
  public static final int QUOTE_ASSET_AMOUNT_WITH_UNSETTLED_LP_OFFSET = 912;
  public static final int REFERENCE_PRICE_OFFSET_OFFSET = 920;
  public static final int AMM_INVENTORY_SPREAD_ADJUSTMENT_OFFSET = 924;
  public static final int REFERENCE_PRICE_OFFSET_DEADBAND_PCT_OFFSET = 925;
  public static final int PADDING_OFFSET = 926;
  public static final int LAST_FUNDING_ORACLE_TWAP_OFFSET = 928;
