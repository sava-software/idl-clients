...
public record VaultWithProtocolParams(byte[] name,
                                      ...
                                      VaultProtocolParams vaultProtocol) implements SerDe {
  ...
  public static final int VAULT_PROTOCOL_OFFSET = 75;

  public static VaultWithProtocolParams read(final byte[] _data, final int _offset) {
